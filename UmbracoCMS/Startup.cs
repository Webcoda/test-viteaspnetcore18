...
namespace UmbracoCMS
{
    public class Startup
    {
        ...
        {
            services.AddViteServices().AddUmbraco(_env, _config)
                .AddBackOffice()
                .AddWebsite()
                .AddComposers()
                .Build();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            if (env.IsProduction())
            {
                ...
                // Add dist/ as secondary "wwwroot". Only for Front End assets purpose,
                // dist/ is ignored and only contains generated assets from FE_DEV
